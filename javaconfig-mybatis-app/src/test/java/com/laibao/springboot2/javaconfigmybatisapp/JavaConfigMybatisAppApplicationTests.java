package com.laibao.springboot2.javaconfigmybatisapp;
...
@SpringBootTest(classes = JavaConfigMybatisAppApplication.class)
public class JavaConfigMybatisAppApplicationTests {
